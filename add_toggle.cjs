...
const target = `                              <option value="Atrasado" className="bg-[#140e0c] text-[#e0d3a8]">Atrasado</option>
                            </select>
                          </div>
                        </div>`;
const replacement = `                              <option value="Atrasado" className="bg-[#140e0c] text-[#e0d3a8]">Atrasado</option>
                            </select>
                          </div>
                        </div>
